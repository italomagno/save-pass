...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    const prevLoginData = response? JSON.parse(response): []

    const newAndPrevLoginData = [
      ...prevLoginData,
      newLoginData
    ]

    console.log(newAndPrevLoginData)
    const newData = JSON.stringify(newAndPrevLoginData)
